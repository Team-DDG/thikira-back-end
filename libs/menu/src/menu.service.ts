...
export class MenuService {
  ...
  public async get_menu_category(menu_category_id: number): Promise<ResGetMenuCategory> {
    ...
    return { mc_id: found_menu_category.id, name: found_menu_category.name };
  }
  ...
  public async get_menu_category_list(token: string): Promise<ResGetMenuCategory[]> {
    ...
    for (const loop_menu_category of found_menu_category) {
      result.push({ mc_id: loop_menu_category.id, name: loop_menu_category.name });
    }
    return result;
  }
  ...
  public async get_menu(menu_id: number): Promise<ResGetMenu> {
    ...
    const menu_data = { m_id: found_menu.id, ...found_menu, id: undefined, group: undefined };
    delete menu_data.id;
    return menu_data;
  }
  ...
  public async edit_menu(payload: DtoEditMenu): Promise<void> {
    ...
    const edit_data = { ...payload, m_id: undefined };
    delete edit_data.m_id;
  ...
  public async get_group(group_id: number): Promise<ResGetGroup> {
    ...
    const group_data = { g_id: found_group.id, ...found_group, id: undefined, option: undefined };
  ...
  public async edit_group(payload: DtoEditGroup): Promise<void> {
    ...
    const edit_data = { ...payload, g_id: undefined };
    delete edit_data.g_id;
  ...
  public async get_option(option_id: number): Promise<ResGetOption> {
    ...
    const option_data = { o_id: found_option.id, ...found_option, id: undefined, option: undefined };
  ...
  public async edit_option(payload: DtoEditOption): Promise<void> {
    const found_option: Option = await this.db_service.find_option_by_id(payload.o_id);
    const edit_data = { ...payload, o_id: undefined };
    delete edit_data.o_id;
